    ...
    if (teks == '404') {
      ...
      const sections = [
      {
        ...
        rows: [
          ...
          { title: 'Kerang Ajaib', rowId: `.kerangajaib` },
          { title: 'Quotes', rowId: `.quotes` },
          { title: 'Grup', rowId: `.grup` },
          { title: 'Premium', rowId: `.premium` },
          { title: 'Internet', rowId: `.internet` },
          { title: 'Anonymous', rowId: `.anonymous` },
          { title: 'Nulis & Logo', rowId: `.nulis` },
          { title: 'Downloader', rowId: `.downloader` },
          { title: 'Tools', rowId: `.tools` },
          { title: 'Fun', rowId: `.fun`},
          { title: 'Database', rowId: `.database` },
          { title: 'Vote & Absen', rowId: `.vote` },
          { title: "Al-Qur\'an", rowId: `.quran` },
          { title: 'Pengubah Suara', rowId: `.audio` },
          { title: 'Jadi Bot', rowId: `.jadibot` },
          { title: 'Info', rowId: `.info` },
          { title: 'Tanpa Kategori', rowId: `.tanpakategori` },
